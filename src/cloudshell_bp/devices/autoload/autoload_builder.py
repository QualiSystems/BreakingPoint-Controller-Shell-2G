...
from cloudshell_bp.shell.core.driver_context import AutoLoadAttribute, AutoLoadDetails, AutoLoadResource
...
class AutoloadDetailsBuilder(object):
    ...
    def _build_autoload_details(self, autoload_data, relative_path=""):
        ...
        self._autoload_details.attributes.extend(
            [
                AutoLoadAttribute(
                    relative_address=relative_path, attribute_name=attribute_name, attribute_value=attribute_value
                )
                for attribute_name, attribute_value in autoload_data.attributes.iteritems()
            ]
        )
