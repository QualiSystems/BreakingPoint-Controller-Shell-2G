...
from cloudshell_bp.devices.networking_utils import UrlParser, command_logging, serialize_to_json
from cloudshell_bp.devices.runners.interfaces.configuration_runner_interface import ConfigurationOperationsInterface
from cloudshell_bp.shell.core.interfaces.save_restore import (
...
class ConfigurationRunner(ConfigurationOperationsInterface):
    ...
    def save(self, folder_path="", configuration_type="running", vrf_management_name=None, return_artifact=False):
        ...
        self.save_flow.execute_flow(
            folder_path=folder_path, configuration_type=configuration_type.lower(), vrf_management_name=vrf_management_name
        )
    ...
    def restore(self, path, configuration_type="running", restore_method="override", vrf_management_name=None):
        ...
        self.restore_flow.execute_flow(
            path=path,
    ...
    def orchestration_restore(self, saved_artifact_info, custom_params=None):
        ...
        if (
            saved_config.restore_rules.requires_same_resource
        ...
        restore_params = {
            ...
            "path": "{}:{}".format(saved_config.saved_artifact.artifact_type, saved_config.saved_artifact.identifier),
        }
    ...
    def _validate_artifact_info(self, saved_config):
        ...
        if is_fail:
            raise Exception(
                ...
                "Mandatory field {0} is missing in Saved Artifact Info request json".format(fail_attribute),
            )
