...
class ConnectionParams(object):
    ...
    def from_dict(cls, dictionary):
        ...
        con_params.vlanServiceAttributes = [AttributeNameValue.from_dict(attr) for attr in dictionary["vlanServiceAttributes"]]
...
class ConnectivityActionRequest(object):
    ...
    def from_dict(cls, json):
        ...
        if "connectorAttributes" in json:
            request.connectorAttributes = [AttributeNameValue.from_dict(attr) for attr in json["connectorAttributes"]]
        else:
            request.connectorAttributes = []

        if "customActionAttributes" in json:
            request.customActionAttributes = [AttributeNameValue.from_dict(attr) for attr in json["customActionAttributes"]]
        else:
