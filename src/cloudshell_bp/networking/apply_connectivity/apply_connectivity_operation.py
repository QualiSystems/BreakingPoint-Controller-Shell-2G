...
from cloudshell_bp.core.driver_request import DriverRequest
...
from cloudshell_bp.networking.apply_connectivity.models.connectivity_request import ConnectivityActionRequest
