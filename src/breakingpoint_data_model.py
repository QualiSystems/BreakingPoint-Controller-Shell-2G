...
class BreakingpointControllerShell2G(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'BreakingPoint Controller Shell 2G'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype BreakingpointControllerShell2G
        """
        result = BreakingpointControllerShell2G(name=context.resource.name)
    ...
    def cloudshell_model_name(self):
        ...
        :return:
        """
        return 'BreakingpointControllerShell2G'
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['BreakingPoint Controller Shell 2G.User'] if 'BreakingPoint Controller Shell 2G.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['BreakingPoint Controller Shell 2G.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['BreakingPoint Controller Shell 2G.Password'] if 'BreakingPoint Controller Shell 2G.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['BreakingPoint Controller Shell 2G.Password'] = value
    ...
    def address(self):
        ...
        :rtype: str
        """
        return self.attributes['BreakingPoint Controller Shell 2G.Address'] if 'BreakingPoint Controller Shell 2G.Address' in self.attributes else None
    ...
    def address(self, value):
        ...
        :type value: str
        """
        self.attributes['BreakingPoint Controller Shell 2G.Address'] = value
    ...
    def client_install_path(self):
        ...
        :rtype: str
        """
        return self.attributes['BreakingPoint Controller Shell 2G.Client Install Path'] if 'BreakingPoint Controller Shell 2G.Client Install Path' in self.attributes else None
    ...
    def client_install_path(self, value):
        ...
        :type value: str
        """
        self.attributes['BreakingPoint Controller Shell 2G.Client Install Path'] = value
    ...
    def controller_tcp_port(self):
        ...
        :rtype: str
        """
        return self.attributes['BreakingPoint Controller Shell 2G.Controller TCP Port'] if 'BreakingPoint Controller Shell 2G.Controller TCP Port' in self.attributes else None
    ...
    def controller_tcp_port(self, value):
        ...
        :type value: str
        """
        self.attributes['BreakingPoint Controller Shell 2G.Controller TCP Port'] = value
    ...
    def test_files_location(self):
        ...
        :rtype: str
        """
        return self.attributes['BreakingPoint Controller Shell 2G.Test Files Location'] if 'BreakingPoint Controller Shell 2G.Test Files Location' in self.attributes else None
    ...
    def test_files_location(self, value):
        ...
        :type value: str
        """
        self.attributes['BreakingPoint Controller Shell 2G.Test Files Location'] = value
