...
from src.driver import BreakingPointControllerShell2GDriver
...
@pytest.fixture()
def driver(test_helpers: TestHelpers, server: dict) -> Iterable[BreakingPointControllerShell2GDriver]:
    ...
    driver = BreakingPointControllerShell2GDriver()
...
@pytest.fixture()
def context(session: CloudShellAPISession, test_helpers: TestHelpers, context_wo_ports: ResourceCommandContext, server: list) -> ResourceCommandContext:
    """Yield ResourceCommandContext for shell command testing."""
    ...
    reservation_ports = get_resources_from_reservation(context_wo_ports, f"{BREAKINGPOINT_CHASSIS_MODEL}.GenericTrafficGeneratorPort")
...
class TestStcControllerDriver:
    ...
    def test_load_config(self, driver: BreakingPointControllerShell2GDriver, context: ResourceCommandContext) -> None:
    ...
    def test_run_traffic(self, driver: BreakingPointControllerShell2GDriver, context: ResourceCommandContext) -> None:
    ...
    @pytest.mark.usefixtures("skip_if_offline")
    def test_run_sequencer(self, driver: BreakingPointControllerShell2GDriver, context: ResourceCommandContext) -> None:
